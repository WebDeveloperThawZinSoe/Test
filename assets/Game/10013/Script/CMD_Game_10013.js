//CMD_Game.js
CMD_GAME_10013 = new cc.Class({ //window.
    ctor: function () {
        this.CARD_TEST = true;
        //游戏属性
        this.KIND_ID = 10013;
        ...
        this.GAME_TYPE_GAME_4 = (this.RuleValue3)							//大吃小
        this.GAME_TYPE_GAME_5 = (this.RuleValue4)							//明牌大吃小
        ...
        this.GAME_TYPE_BASE3 = (this.RuleValue12)							//4
        ...
        //封顶
        this.GAME_TYPE_MAX_ADD1 = (this.RuleValue24)							//100
        this.GAME_TYPE_MAX_ADD2 = (this.RuleValue25)							//200
        this.GAME_TYPE_MAX_ADD3 = (this.RuleValue26)							//300
        this.GAME_TYPE_MAX_ADD4 = (this.RuleValue27)							//500
        this.GAME_TYPE_MAX_ADD5 = (this.RuleValue30)							//1000
    ...
    GetGameMode: function (ServerRules, RulesArr) {
        ...
        if (RulesArr[0] & this.GAME_TYPE_GAME_2) str = '三公轮庄';
        if (RulesArr[0] & this.GAME_TYPE_GAME_3) str = '自由抢庄';
        if (RulesArr[0] & this.GAME_TYPE_GAME_4) str = '大吃小';
        if (RulesArr[0] & this.GAME_TYPE_GAME_5) str = '明牌大吃小';
        return str;
    },
    //游戏底分
    GetBaseScore: function (ServerRules, RulesArr) {
        ...
        if (RulesArr[0] & this.GAME_TYPE_BASE3) score = 4;
    ...
    GetAddScore: function (ServerRules, RulesArr) {
        ...
        if (RulesArr[0] & this.GAME_TYPE_ADD2) score = 5;
        if (RulesArr[0] & this.GAME_TYPE_ADD3) score = 10;
        if (RulesArr[0] & this.GAME_TYPE_ADD4) score = 15;
        if (RulesArr[0] & this.GAME_TYPE_ADD5) score = 20;
        return score;
    },
    ...
    GetRulesStr: function (ServerRules, RulesArr) {
        ...
        if (RulesArr[0] & this.GAME_TYPE_MAX_ADD1) str += " 下注封顶：" + this.GetBaseScoreStr(ServerRules, RulesArr) * 100;
        if (RulesArr[0] & this.GAME_TYPE_MAX_ADD2) str += " 下注封顶：" + this.GetBaseScoreStr(ServerRules, RulesArr) * 200;
        if (RulesArr[0] & this.GAME_TYPE_MAX_ADD3) str += " 下注封顶：" + this.GetBaseScoreStr(ServerRules, RulesArr) * 400;
        if (RulesArr[0] & this.GAME_TYPE_MAX_ADD4) str += " 下注封顶：" + this.GetBaseScoreStr(ServerRules, RulesArr) * 500;
        if (RulesArr[0] & this.GAME_TYPE_MAX_ADD5) str += " 下注封顶：" + this.GetBaseScoreStr(ServerRules, RulesArr) * 1000;
