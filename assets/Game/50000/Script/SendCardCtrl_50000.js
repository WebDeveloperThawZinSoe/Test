...
cc.Class({
    ...
    GetCard :function(){
        ...
        var TempCtrl = TempCard.getComponent('CardPrefab_50000');
    ...
    PlaySendCard:function (cnt, StateArr){  
        ...
        for(var i=0;i<cnt;i++){
            ...
            this.SetNodeAct(TempCard.node, i, 0);
        }
        // for(var i=0;i<cnt;i++){
    ...
    SetNodeAct:function (node, turn, wChairID){
        ...
        var act1 = cc.spawn( cc.scaleTo(actTime, 1), cc.moveTo(actTime, this.m_PosArr[turn]));
        var act1 = cc.moveTo(actTime, this.m_PosArr[turn]);
