...
cc.Class({
    ...
    SetCardData:function (cbCardData, cbCardCount){
        ...
        if( this.m_CardItemArray == null ) this.Init();
        //扑克数目
        ...
        for (var i = 0; i < this.m_cbCardCount; i++) {
            ...
            if( this.m_CardItemArray[i].card == null ){
                this.m_CardItemArray[i].card = cc.instantiate(this.m_cardPre).getComponent('CardPrefab_62016');
    ...
    //绘画扑克
    DrawCard:function () {
        this.$('@Layout').spacingX = this.m_nXDistance - CARD_WIGTH;//*this.m_scale
