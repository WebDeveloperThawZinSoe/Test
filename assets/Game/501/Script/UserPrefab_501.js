cc.Class({
    ...
    setBiPin: function(bShow){

        this.$('sp_lipin').active = bShow;
    },
    OnClickedKick:function(){
        this.m_Hook.m_GameClientEngine.OnBtKick(this.m_dwUserID);
    },

    OnBtKickShow:function(bshow){
        this.m_BtTiChu.node.active = false;
    },
});