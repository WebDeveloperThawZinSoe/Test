cc.Class({
    ...
    SetEndInfo:function(pEndInfo,dwCreater){
        ...
        for(var i = 0;i<GameDef.GAME_PLAYER;i++){
            ...
            this.m_ListCtrl.InsertListInfo(0, [i, pEndInfo, wWinner, pEndInfo.UserID[i] == dwCreater]);
        }
    },
    //分享信息
...
//pre
    ...
    SetUserEndInfo:function(wChair, EndInfo, Winner, bSelf) {
        ...
        this.m_spriteBigWinner.active = Winner==wChair;
        this.m_spFangZhu.active = bSelf;
    },
/////////////////////////////////////////////////////////////////////// 
});