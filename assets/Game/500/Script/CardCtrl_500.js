...
cc.Class({
    ...
    _updateMaCard: function () {
        for (var i in this.m_Cards) {
            if (this.m_Cards[i].node.active) {
                if(this.m_Cards[i].GetData() == GameDef.m_MaCard) this.m_Cards[i].node.color = cc.color(248,195,205);
                else this.m_Cards[i].node.color = cc.color(255,255,255);
            }
        }
    },
    ...
    updateTips: function () {
        ...
        this.m_Tips[TIP_SHUNZI] = GameLogic.getInstance().SearchLineCardType(cbCard, cbCard.length, 5);
        this.m_Tips[TIP_TONGHUA] = GameLogic.getInstance().SearchSameColorType(cbCard, cbCard.length, 5);
        ...
        this.m_Tips[TIP_TONGHUASHUN] = GameLogic.getInstance().SearchSameColorLineType(cbCard, cbCard.length, 5);
