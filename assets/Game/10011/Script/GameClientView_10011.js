...
cc.Class({
    ...
    onLoad:function () {
        ...
        this.m_BtCompition = this.$('BtUINode/OpenUI/BtCompition@Button');
        ...
        this.m_UserCardControl[GameDef.MYSELF_VIEW_ID].SetGameEngine(this.m_GameClientEngine); 
    ...
    InitTableCard:function(){
        for (var i = 0; i < GameDef.GAME_PLAYER; i++) {
            ...
            this.m_UserCardControl[i].SetBlackCard(GameDef.MAX_COUNT);
        }
        this.SetCardType(INVALID_CHAIR);
    },
 ...
 //////////////////////////////////////////////////////////////////////////////
    ...
    OnClick_BtHint:function (){
        this.m_GameClientEngine.OnMessageHint(GameDef.MAX_COUNT);
    },
    
    //组牌
    OnClick_BtCompition:function (){
        this.m_GameClientEngine.OnMessageCombiCard();
    },
    ...
    OnBnClickedShowCard:function (){
        this.m_UserCardControl[GameDef.MYSELF_VIEW_ID].SetCardData(this.m_CardArr, GameDef.GetCardCount());
    },
 ...
 //////////////////////////////////////////////////////////////////////////////
     ...
     * @param bIsHint 已经提示
     */
    ShowOpenUI :function(bShow,bIsHint,bIsFourCount){
        if (bShow == null || bShow == undefined)bShow = false;
        if (bIsHint == null || bIsHint == undefined)bIsHint = false;
        if (bIsFourCount == null || bIsFourCount == undefined)bIsHint = false;

        this.m_OpenUI.active = bShow;
        this.m_BtCompition.node.active = bIsFourCount;
        this.m_BtCompition.interactable = !bIsHint;

        this.m_BtHint.active = (!bIsFourCount && bIsHint);
        
        this.m_UserCardControl[GameDef.MYSELF_VIEW_ID].setTouchEnabled(bShow && bIsFourCount);
    },
     ...
     * @param times 倍数
     */
    SetCardType:function(ViewID, Type, JHType){
        if(ViewID == INVALID_CHAIR){
            for(var i=0;i<this.m_playerCnt;i++){
                this.m_UserCardType[i].SetCardType();
            }
        ...
        if (Type == GameDef.OX_VALUE_FINISH)
        {
            ...
            this.m_UserCardType[ViewID].SetCardType(Type,JHType)
    },
