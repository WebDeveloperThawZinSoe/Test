cc.Class({
    ...
    OnUpdateCustomView:function(){
        ...
        var BankerMode = 0;//0明牌抢庄 1三公轮庄 2自由抢庄
        ...
        if(this.$('ScrollView/view/content/NdChild/CardMode/CardMode/1023@Toggle').isChecked) CardCnt=3;
        if(this.$('ScrollView/view/content/NdChild/CardMode/CardMode/1024@Toggle').isChecked) CardCnt=4;
        
        this.$('ScrollView/view/content/NdView/CardMode/Label@Label').string = CardCnt+'张';
    ...
    onUpdateBaseScoreRule:function(GameMode,playType){
        ...
        ruleBase_1.push(400);
        ruleBase_1.push(500);
        ruleBase_1.push(1000);
        ruleBase_1.push(2000);
        ...
        for (var i = 0 ; i < ruleBase.length ; i++)
        {
            ...
            if (playType == 1)
                tempStr = ruleBase_1[i] + '-' + ruleBase_1[i] * 2;
