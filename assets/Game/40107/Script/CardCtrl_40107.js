...
cc.Class({
    ...
    SetCardData:function (cbCardData, cbCardCount){
        ...
        if(cbCardCount == 0) this.m_Count = 0;
        ...
        for (var i = 0; i < this.m_cbCardCount; i++) {
            ...
            if( this.m_CardItemArray[i].card == null ){
                this.m_CardItemArray[i].card = cc.instantiate(this.m_cardPre).getComponent('CardPrefab_40107');
    ...
    DrawCard:function () {
        ...
        for (var i=0; i < MAX_CARD_COUNT; i++){
            if(i < this.m_cbCardCount){
                ...
                this.m_CardItemArray[i].card.setSelect( this.m_bSelect[i] );
                if(i<this.m_Count)   this.m_CardItemArray[i].card.setLetCard(true );
            }else{
                this.m_CardItemArray[i].bShoot = false; 
                if( this.m_CardItemArray[i].card != null ){
                    this.m_CardItemArray[i].card.node.active = false;
                    this.m_CardItemArray[i].card.setLetCard(false);
                }
    ...
    SetLetCard:function(cbCount){
        this.m_Count = cbCount;
        this.DrawCard();
    },
